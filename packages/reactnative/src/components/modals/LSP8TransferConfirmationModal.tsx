import { HStack, Button as RNButton, Text, View, VStack } from 'native-base';
...
export default function LSP8TransferConfirmationModal({
    ...
    <View bgColor="white" borderRadius="30" w={WINDOW_WIDTH * 0.9}>
      <VStack bgColor="white" borderRadius="30" p="5" space={4}>
          ...
          >
            <HStack alignItems="center" space="2">
              ...
              <Text fontSize={FONT_SIZE['xl']} fontWeight="medium">
                {truncateAddress(params.txData.from.address)}
              </Text>
            </HStack>
          </HStack>
        </VStack>
        ...
        <Text fontSize={2 * FONT_SIZE['xl']} bold textAlign="center">
          {convertBytesToNumber(params.txData.tokenId)}
        </Text>
