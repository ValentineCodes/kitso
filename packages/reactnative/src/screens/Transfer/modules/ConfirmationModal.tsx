    ...
    return (
        <Modal isVisible={isVisible} animationIn="slideInUp" animationOut="zoomOut" onBackButtonPress={onClose} onBackdropPress={onClose}>
            <VStack bgColor="white" borderRadius="30" p="5" space={4}>
                    ...
                    <HStack alignItems="center" justifyContent="space-between" bgColor="#F5F5F5" borderRadius="10" p="2">
                        <HStack alignItems="center" space="2">
                            ...
                            <VStack w="75%">
                                ...
                                <Text fontSize={FONT_SIZE['md']}>Balance: {formatBalance()} {connectedNetwork.token}</Text>
                            </VStack>
                        </HStack>
                    </HStack>
                </VStack>
                ...
                <Text fontSize={2 * FONT_SIZE["xl"]} bold textAlign="center">{txData.amount} {connectedNetwork.token}</Text>
                ...
                <VStack borderWidth="1" borderColor="muted.300" borderRadius="10">
                    <HStack p="3" alignItems="flex-start" justifyContent="space-between">
                        ...
                        <Text fontSize={FONT_SIZE['lg']} fontWeight="medium" w="50%" textAlign="right">{estimateGasCost && parseFloat(ethers.utils.formatEther(estimateGasCost), 8)} {connectedNetwork.token}</Text>
                    </HStack>
                    ...
                    <HStack p="3" alignItems="flex-start" justifyContent="space-between">
                        ...
                        <Text fontSize={FONT_SIZE['lg']} fontWeight="medium" w="50%" textAlign="right">{calcTotal()} {connectedNetwork.token}</Text>
                    </HStack>
                </VStack>
